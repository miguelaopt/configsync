...
Last updated 2026-09-20, after PR #37 was merged and deployed. Live version **0.4.0**.
...
| Deployed commit | `9e2ee8b` (merge of PR #37), version 0.4.0                                                     |
...
PRs #1–#37, all merged except #24 (superseded by this file). #1 foundation, #2 ConfigSync rebrand +
...
`/changelog`, #37 one version number from `package.json`.

Version history: 0.1.0 foundation (17 Sep) · 0.2.0 launch (18 Sep) · 0.3.0 import review + Nocturne
(19 Sep) · 0.4.0 game pages, docs, SEO (20 Sep).
